...
namespace SteadyGrowth.Web.Data.Migrations
{
    ...
    [Migration("20260129204822_AddFreelancerApplication")]
    partial class AddFreelancerApplication
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SteadyGrowth.Web.Models.Entities.CourseProgress", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SteadyGrowth.Web.Models.Entities.CourseSegment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SteadyGrowth.Web.Models.Entities.PendingRegistration", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SteadyGrowth.Web.Models.Entities.SegmentProgress", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int>("CourseSegmentId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("CourseSegmentId");

                    b.HasIndex("IsCompleted");

                    b.HasIndex("UserId");

                    b.HasIndex("UserId", "CourseSegmentId")
                        .IsUnique();
            ...
            modelBuilder.Entity("SteadyGrowth.Web.Models.Entities.WithdrawalRequest", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SteadyGrowth.Web.Models.Entities.CourseProgress", b =>
                {
                    b.HasOne("SteadyGrowth.Web.Models.Entities.Course", "Course")
                        .WithMany()
            ...
            modelBuilder.Entity("SteadyGrowth.Web.Models.Entities.PendingRegistration", b =>
                {
                    b.HasOne("SteadyGrowth.Web.Models.Entities.User", "CreatedUser")
                        .WithMany()
                        .HasForeignKey("CreatedUserId")
                        .OnDelete(DeleteBehavior.NoAction);

                    b.HasOne("SteadyGrowth.Web.Models.Entities.User", "ProcessedByUser")
                        .WithMany()
                        .HasForeignKey("ProcessedByUserId")
                        .OnDelete(DeleteBehavior.NoAction);

                    b.HasOne("SteadyGrowth.Web.Models.Entities.AcademyPackage", "SelectedPackage")
                        .WithMany()
            ...
            modelBuilder.Entity("SteadyGrowth.Web.Models.Entities.SegmentProgress", b =>
                {
                    b.HasOne("SteadyGrowth.Web.Models.Entities.CourseSegment", "CourseSegment")
                        .WithMany()
                        .HasForeignKey("CourseSegmentId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
