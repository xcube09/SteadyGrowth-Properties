...
{
    /// <inheritdoc />
    public partial class AddAllModelEntitiesDbSets : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_VettingLogs", x => x.Id);
                    table.ForeignKey(
                        name: "FK_VettingLogs_AspNetUsers_AdminUserId",
                        column: x => x.AdminUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_VettingLogs_Properties_PropertyId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_VettingLogs_AdminUserId",
                table: "VettingLogs",
                column: "AdminUserId");

            migrationBuilder.CreateIndex(
                name: "IX_VettingLogs_PropertyId",
                table: "VettingLogs",
                column: "PropertyId");
        }
