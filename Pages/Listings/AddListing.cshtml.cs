...
namespace SteadyGrowth.Web.Pages.Listings
{
    [Authorize]
    public class AddListingModel : PageModel
    {
        ...
        public AddListingModel(PropertyService propertyService, UserManager<User> userManager, IWebHostEnvironment env)
        {
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            ...
            return RedirectToPage("/Listings/Success");
        }
    }
}
